...
import {City} from "../app/shared/services/city.service";
...
describe('HttpClient testing', () => {
  ...
  it('can test HttpClient.get with matching header', () => {
    const testData: City = {name: 'Test City', count:1};
  ...
  it('can test for 404 error', () => {
    ...
    httpClient.get<City[]>(testUrl).subscribe({
